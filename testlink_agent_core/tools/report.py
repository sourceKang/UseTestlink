            ...
            **schema(
                {
                    ...
                    "audit_dir": string("Directory for write audit JSON files."),
        ...
        "inputSchema": schema(
            {
                ...
                "redmine_group_failures": {
                    "type": "boolean",
                    "default": False,
                    "description": "Create or reuse one shared Redmine issue for all failed results in the report.",
                },
                "redmine_subject": string("Override the generated Redmine subject."),
                "redmine_subject_file": string("UTF-8 file containing the Redmine subject."),
                "redmine_description": string("Override the generated Redmine description."),
                "redmine_description_file": string("UTF-8 file containing the Redmine description."),
                ...
                "audit_dir": string("Directory for write audit JSON files."),
                "resume_audit": string("Previous upload-report audit JSON used to skip completed TestLink writes."),
            },
